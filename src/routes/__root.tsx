...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BahiBook — Smart Khata for Small Business" },
      { name: "description", content: "Free offline khata, ledger and bookkeeping app for shopkeepers and small businesses. No ads, no subscriptions." },
      { property: "og:title", content: "BahiBook — Smart Khata" },
